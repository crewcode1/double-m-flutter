...
class LoginUseCase extends UseCase<AuthSession, LoginRequestBody> {
  final AuthRepository authRepository;
  LoginUseCase({required this.authRepository});
  @override
  Future<Either<Failure, AuthSession>> call({LoginRequestBody? parameters}) {
    return authRepository.login(request: parameters!);
  }
}
