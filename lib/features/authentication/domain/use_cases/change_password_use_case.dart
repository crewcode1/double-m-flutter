...
class ChangePasswordUseCase extends UseCase<void, ChangePasswordRequestBody> {
  final AuthRepository authRepository;
  ChangePasswordUseCase({required this.authRepository});
  @override
  Future<Either<Failure, void>> call({ChangePasswordRequestBody? parameters}) {
    return authRepository.changePassword(request: parameters!);
  }
}
