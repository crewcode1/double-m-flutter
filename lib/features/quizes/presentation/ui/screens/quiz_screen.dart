...
import 'package:doublem/features/quizes/presentation/ui/widgets/quiz_question_card.dart';
import 'package:doublem/features/quizes/presentation/ui/widgets/submit_quiz_button.dart';
...
class _QuizScreenState extends State<QuizScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: 'Quiz 4'),
      body: Column(
        children: [
          Expanded(
